...
#import "NJSearchVCViewController.h"

@interface NJSearchVCViewController ()
@property (nonatomic, strong) UISearchController *searchController;
@end

@implementation NJSearchVCViewController
...
//    [self.searchController.searchBar setImage:[UIImage imageNamed:@"ic_search_small"] forSearchBarIcon:UISearchBarIconSearch state:UIControlStateNormal];
